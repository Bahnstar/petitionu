defmodule PetitionuWeb.Router do
  use PetitionuWeb, :router
  ...
  scope "/", PetitionuWeb do
    ...
    ash_authentication_live_session :authenticated_routes do
      ...
      # on_mount {PetitionuWeb.LiveUserAuth, :live_user_required}
      #
      # If an authenticated user *may* be present:
      # on_mount {PetitionuWeb.LiveUserAuth, :live_user_optional}
      #
  ...
  scope "/api/json" do
    ...
    forward "/", PetitionuWeb.AshJsonApiRouter
  end
  ...
  scope "/", PetitionuWeb do
    ...
    auth_routes AuthController, Petitionu.Accounts.User, path: "/auth"
  ...
  # scope "/api", PetitionuWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:petitionu, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: PetitionuWeb.Telemetry
