...
config :petitionu, PetitionuWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: PetitionuWeb.ErrorHTML, json: PetitionuWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Petitionu.PubSub,
  live_view: [signing_salt: "pCqLPadb"]
...
config :petitionu, Petitionu.Mailer, adapter: Swoosh.Adapters.Local
