...
const AshTypescriptGuide = () => {
    const [petitions, setPetitions] = useState<
        SuccessDataFunc<typeof listPetitions>
    >([]);
    useEffect(() => {
        ...
        const fetchPetitions = async () => {
            ...
            setPetitions(
                getPetitions.data as SuccessDataFunc<typeof listPetitions>,
            );
        };
                ...
                <div className="space-y-12">
                    <section className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
                        ...
                        <p className="text-slate-700 mb-6 text-lg leading-relaxed">
                            Add the AshTypescript.Rpc extension to your domain
                            and configure RPC actions:
                        </p>
  ...
  resources do
    resource MyApp.Accounts.User
                    ...
                    <section className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
                        ...
                        <p className="text-slate-700 mb-6 text-lg leading-relaxed">
                            When running the dev server, TypeScript types are
                        ...
                        <div className="bg-orange-50 border border-orange-200 rounded-lg p-6 mb-6">
                            <p className="text-slate-700 text-lg leading-relaxed">
                                ...
                                TypeScript files are automatically regenerated
                                whenever you make changes to your resources or
                                expose new RPC actions. No manual codegen step
                                required during development!
                            </p>
                        </div>
                        <p className="text-slate-600 mb-4">
                            For production builds or manual generation, you can
                            also run:
                        </p>
                        <pre className="rounded-lg text-sm border">
                            <code className="language-bash">
                                mix ash_typescript.codegen --output
                                "assets/js/ash_generated.ts"
                            </code>
                        </pre>
                    </section>
                    ...
                    <section className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
                        ...
                        <p className="text-slate-700 mb-6 text-lg leading-relaxed">
                            Import the generated RPC functions in your
    ...
    console.error("Network error:", error);
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-600">
                                        Complete API reference and guides on
                                        HexDocs
                                    </p>
                                </div>
                            </a>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-600">
                                        View the source, report issues, and
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-600">
                                        See AshTypescript with TanStack Query &
                                        Table in action
                                    </p>
                    ...
                    <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl shadow-lg p-8 text-center">
                        ...
                        <p className="text-orange-100 text-lg leading-relaxed max-w-2xl mx-auto">
                            Check your generated RPC functions and start
                            building type-safe interactions between your
                            frontend and Ash resources!
                        </p>
                    </div>
                </div>
            </div>
